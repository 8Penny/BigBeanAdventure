...
public class PlayerMovement : MonoBehaviour {
    ...
    void FixedUpdate() {
        ...
        transform.Translate(speedX, 0, 0); // движение
    ...
    { if (col.gameObject.tag == "Ground") { isGrounded = true; animator.ResetTrigger("Jump"); } }

    void OnCollisionExit2D(Collision2D colex) // проверка "покидания" земли
    { if (colex.gameObject.tag == "Ground") { isGrounded = false; } }
